...
function App() {
  return (
    <div className="min-h-screen bg-background selection:bg-primary selection:text-background text-white overflow-x-hidden">
      ...
      <FloatingElement speed={0.2} className="fixed top-[20%] left-[5%] opacity-20 hidden md:block">
      ...
      <FloatingElement speed={0.1} className="fixed top-[60%] right-[5%] opacity-15 hidden md:block">
