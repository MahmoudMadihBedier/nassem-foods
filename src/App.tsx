...
function App() {
  return (
    <div className="min-h-screen bg-background selection:bg-primary selection:text-white text-zinc-900 overflow-x-hidden">
      ...
      <FloatingElement speed={0.2} className="fixed top-[20%] right-[5%] opacity-10 hidden md:block">
        <div className="w-12 h-12 border border-primary rotate-45" />
      </FloatingElement>
      <FloatingElement speed={-0.3} className="fixed bottom-[20%] left-[10%] opacity-10 hidden md:block">
        <div className="w-32 h-32 rounded-full border border-secondary" />
      </FloatingElement>
      <FloatingElement speed={0.1} className="fixed top-[60%] left-[5%] opacity-10 hidden md:block">
