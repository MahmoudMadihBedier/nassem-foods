          ...
          <Tilt>
            <div className="relative group">
              ...
              <div
                ...
                className="absolute -bottom-10 -right-4 w-40 h-40 bg-gradient-to-br from-primary to-primary-container rounded-[2.5rem] p-8 flex flex-col justify-center items-center text-background shadow-[0_20px_50px_rgba(255,184,0,0.4)] rotate-12"
              >
